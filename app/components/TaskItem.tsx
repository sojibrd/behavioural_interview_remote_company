 ...
 * আর মিনিট / ⚑ / 🔁 / 🧠 chip।
 *
 * কাজে `(ডক ০২.০২)` থাকলে এই সাইটের ঐ ডকের পাতার লিংক। story-র লেখা এখানে নয় —
 * ইংরেজিতে বুলেট আর ফোনের রেকর্ড সাইটের বাইরে থাকে।
 *
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-2 flex flex-wrap gap-1.5">
          ...
          {task.sources.map((source) => (
            <Link key={`doc-${source.code}`} href={source.href} className="chip chip--accent" title="এই সাইটে ঐ ডক">
              ডক {source.label} · {source.title}
            </Link>
          ))}
          {checked && (
